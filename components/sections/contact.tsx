...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await emailjs.send("service_y5ggft9", "template_vgg0stb", formData, {
      ...
      toast({
        ...
        description: `${t("form.name")}: ${formData.name}, ${t("form.email")}: ${formData.email}`,
        variant: "default",
      });
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      label: t("info.phone"),
      value: "+20 101 716 6378",
      href: "tel:+201017166378",
    },
    {
      icon: <MapPin className="h-5 w-5 text-primary" />,
      label: t("info.location"),
      value: "Giza, Cairo, Egypt",
      href: "https://maps.google.com/?q=Giza, Cairo, Egypt",
    },
  ];
  ...
  const socialLinks = [
    {
      ...
      href: "https://github.com/mahmoud-abu-attiya",
    },
    {
    ...
    },
    {
      ...
      href: "https://www.instagram.com/mahmoud_abu_attiya/",
    },
    {
      icon: (
        <svg
          ...
          fill="#1e90ff"
          width={20}
          xmlns="https://wa.me/+201017166378"
        >
            ...
            <Card className="border-0 p-0 shadow-none">
              <CardContent className="p-6">
                ...
                <div className="mt-8 pt-6 border-t border-border">
                  <h4 className="font-medium mb-4">{t("info.social")}</h4>
